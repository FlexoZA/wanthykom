  ...
  <div class="max-w-4xl mx-auto p-6">
    ...
    <form @submit.prevent="handleSubmit" class="space-y-6">
      ...
      <div>
        ...
        <p class="text-xs text-gray-400 mt-1">Select an image from the media manager</p>

        <!-- Image Preview -->
        <div v-if="selectedImageUrl" class="mt-3">
          <p class="text-sm text-gray-300 mb-2">Selected Image:</p>
          <div class="flex items-center gap-3">
            ...
            <div class="text-sm text-gray-400">
              <p class="font-medium">{{ selectedImageName }}</p>
            </div>
          </div>
        </div>
      </div>
